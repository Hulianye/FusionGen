...
def download_data_BNCI2014_002():
    ...
    data = resample_data(data, 512, 250)
    data = data[:, :, :1000]
    ...
    file_path = os.path.join(save_dir, 'BNCI2014002_data.npz')
...
def import_data_BNCI2014_002():
    loaded = np.load('./data/BNCI2014002_data.npz',allow_pickle=True)
    data = loaded['data']
...
def getdata_002(data, labels, subjects, sessions,session_selected = None, subject_selected = None,val_subect_selected = None,train_num = 10):
...
def getdata_all_002(session_selected = None, subject_selected = None):
